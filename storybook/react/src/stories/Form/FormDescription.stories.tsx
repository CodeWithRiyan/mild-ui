...
const meta: Meta<typeof FormDescription> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A form description component for providing helpful text and instructions to users.',
      },
    },
  },
  argTypes: {
  ...
  render: (args) => (
    <FormDescriptionWrapper>
      <FormDescription {...args}>
        Enter your username. It must be unique and contain only letters and numbers.
      </FormDescription>
    </FormDescriptionWrapper>
  ),
  parameters: {
...
export const LongDescription: Story = {
  render: (args) => (
    <FormDescriptionWrapper>
      <FormDescription {...args}>
        This is a longer description that provides detailed instructions about what the user should enter in this field. 
        It can span multiple lines and provide comprehensive guidance to help users understand the requirements and expectations.
      </FormDescription>
    </FormDescriptionWrapper>
  ),
  parameters: {
...
export const DescriptionWithMarkup: Story = {
  render: (args) => (
    <FormDescriptionWrapper>
      <FormDescription {...args}>
        Password must contain at least <strong>8 characters</strong>, including one <em>uppercase letter</em> and one <em>number</em>.
      </FormDescription>
    </FormDescriptionWrapper>
  ),
  parameters: {
...
export const DescriptionWithInstructions: Story = {
  render: (args) => (
    <FormDescriptionWrapper labelText="API Key">
      <FormDescription {...args}>
        You can find your API key in your account settings. Keep it secure and don't share it publicly.
      </FormDescription>
    </FormDescriptionWrapper>
  ),
  parameters: {
            ...
            render={() => (
              <FormItem>
                ...
                <FormDescription className="text-orange-600">
                  <strong>Security tip:</strong> Use a combination of uppercase letters, 
                  lowercase letters, numbers, and symbols for a strong password.
                </FormDescription>
              </FormItem>
            )}
          />
