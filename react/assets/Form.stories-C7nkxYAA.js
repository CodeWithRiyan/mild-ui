import{j as e}from"./jsx-runtime-BYYWji4R.js";import{c as p,a as h,d as s,e as f,o as w}from"./index.esm-DY745Q6x.js";import{u as g,F as b}from"./index.esm-Caie3due.js";import{I as i}from"./InputPassword-aYkxTyS-.js";import{F as a}from"./Form-5c6Z9IN5.js";import{I as o}from"./Input-CVAyMxhJ.js";import{C as y}from"./Checkbox-AQYbAZW5.js";import{B as m}from"./Button-CtEzI3Z3.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./cn-BghrLRQn.js";import"./createLucideIcon-B01ZNHQN.js";import"./index-BBDW_iF1.js";import"./Label-BNbxhGmQ.js";import"./index-DxWJXrxp.js";import"./index-DEBWUM58.js";import"./index-BlPsc28B.js";import"./check-qWauf3Zf.js";const F=()=>e.jsx(e.Fragment,{}),O={component:F,title:"Components/Form",parameters:{layout:"centered",docs:{description:{component:"A form component that uses React Hook Form and Yup for validation."}}},tags:["autodocs"]},t={render:()=>{const l=p({name:s().required("Name is required").min(2,"Name must be at least 2 characters").max(50,"Name must be less than 50 characters"),email:s().email("Enter a valid email").required("Email is required"),password:s().required("Password is required").min(8,"Password must be at least 8 characters").matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/,"Password must contain at least one uppercase letter, one lowercase letter, and one number"),confirmPassword:s().required("Please confirm your password").oneOf([f("password")],"Passwords must match"),age:s().required("Age is required").matches(/^[0-9]+$/,"Age must be a number").test("is-positive","You must be at least 13 years old",r=>!!(r&&parseInt(r)>=13)),terms:h().required("You must accept the terms and conditions").oneOf([!0],"You must accept the terms and conditions")}),n=g({resolver:w(l),defaultValues:{name:"",email:"",password:"",confirmPassword:"",age:"",terms:!1},mode:"onChange"}),d=()=>e.jsxs("span",{children:[e.jsx("span",{children:"I agree to the "}),e.jsx("a",{href:"#",className:"text-blue-600 hover:underline",children:"Terms and Conditions"}),e.jsx("span",{children:" and "}),e.jsx("a",{href:"#",className:"text-blue-600 hover:underline",children:"Privacy Policy"})]}),u=r=>{console.log("Form Data:",r),alert(`Registration Successful!
Name: ${r.name}
Email: ${r.email}
Password: ${r.password}
Age: ${r.age}
Terms: ${r.terms}`)},c=r=>{console.log("Form Errors:",r)};return e.jsx(b,{...n,children:e.jsxs("form",{onSubmit:n.handleSubmit(u,c),className:"space-y-4",children:[e.jsx(a,{name:"name",label:"Full Name",description:"Enter your full name as it appears on official documents",required:!0,children:e.jsx(o,{placeholder:"Enter your full name",autoComplete:"name",onChange:r=>console.log("Name changed:",r.target.value)})}),e.jsx(a,{name:"email",label:"Email Address",description:"We'll never share your email with anyone else",required:!0,children:e.jsx(o,{type:"email",placeholder:"Enter your email address",autoComplete:"email"})}),e.jsx(a,{name:"age",label:"Age",required:!0,children:e.jsx(o,{type:"number",placeholder:"Enter your age",min:"13",max:"120"})}),e.jsx(a,{name:"password",label:"Password",description:"Must be at least 8 characters with uppercase, lowercase, and numbers",required:!0,children:e.jsx(i,{placeholder:"Create a strong password",autoComplete:"new-password"})}),e.jsx(a,{name:"confirmPassword",label:"Confirm Password",required:!0,children:e.jsx(i,{placeholder:"Confirm your password",autoComplete:"new-password"})}),e.jsx(a,{name:"terms",required:!0,isBoolean:!0,children:e.jsx(y,{required:!0,label:e.jsx(d,{})})}),e.jsx("div",{className:"pt-4",children:e.jsx(m,{type:"submit",disabled:n.formState.isSubmitting,className:"w-full",children:n.formState.isSubmitting?"Creating Account...":"Create Account"})}),e.jsx(m,{type:"button",variant:"outline",onClick:()=>n.reset(),className:"w-full",children:"Reset Form"})]})})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...t.parameters?.docs?.source}}};const V=["RegistrationForm"];export{t as RegistrationForm,V as __namedExportsOrder,O as default};
