// packages/core/src/theme/default-theme.ts
/// Default theme configuration
/// @fileoverview Provides the default theme configuration that matches our SASS tokens

import type { ThemeConfig } from '../types/common';
...
export const darkTheme: Partial<ThemeConfig> = {
  colors: {
    ...
    // Other colors remain the same, only gray is inverted for dark mode
